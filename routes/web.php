...
Route::get('/jawab_ujian/{slug_soal}', ['as' => 'jawab_ujian', 'uses' => 'UjianController@jawab_ujian']);
...
Route::get('/halaman_soal/{id_soal}/{page}', 'UjianController@halaman_soal')->name('halaman_soal');
